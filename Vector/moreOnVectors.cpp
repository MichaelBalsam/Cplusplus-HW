// Example demonstrating VECTOR usage (and more!)
// Read about "sequence containers" here:
// http://en.wikipedia.org/wiki/Sequence_container_(C%2B%2B)
// from where this code is excerpted

#include <iostream>
#include <vector>
#include <algorithm> // sort, max_element, random_shuffle, remove_if, lower_bound 
#include <functional>// greater, bind2nd// used here for convenience, use judiciously in real programs. 
#include<iomanip>
#include<cstdlib>
#include<ctime> 
using namespace std;
...
{    
  ...
  // sort the elements
  sort( numbers.begin(), numbers.end() ); //quick sort
